...
class ClientPhysiqueUrbaineController extends PrivateController{
   
    public function ajouterClientPhysiqueUAction() {
        ...
        $response_data = ClientPhysiqueUrbaineModel::ajouterClientPhysiqueUrbaine($params);
        $response = new Response();
